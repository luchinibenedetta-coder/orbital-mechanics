...
## Physical Model
This satellite is modeled as a point mass moving under the gravitational attraction of Earth. This gravitational acceleration is calculated using Newton's law of universal gravitation:
$$
...
At each time step, the gravitational acceleration is calculated from the satellites current position. The velocity is then updated, followed. it the position.
